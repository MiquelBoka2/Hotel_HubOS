...
@section('content')
    ...
    <div class="content">
        <div class="container">
            ...
            {{ Form::model($reservation, array('method' => 'POST', 'route' => array('reservations.update', $reservation->id))) }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">

                        <div class="panel-heading">
                            <h1 class="page-header">{{ trans('web.edit', array('attribute'=> strtolower(trans_choice('web.reservation',1))))}} {{$room->name}} {{trans('web.in')." ".$room->hotel->name}}</h1>
                        </div>
