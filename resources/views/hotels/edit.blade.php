...
@section('content')
    ...
    <div class="content">
        <div class="container">
            ...
            {{ Form::model($hotel, array('method' => 'PUT', 'route' => array('hotels.update', $hotel->id))) }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">

                        <div class="panel-heading">
                            <h1 class="page-header">{{ trans('web.edit', array('attribute'=> strtolower(trans_choice('web.hotel',1))))}}</h1>
                        </div>
